...
$.validator.addMethod("decimalgreaterthan", function (value, element, params) {
...
*/
$.validator.unobtrusive.adapters.add("decimalgreaterthan", ["otherpropertyname"], function (options) {
    options.rules["decimalgreaterthan"] = "#" + options.params.otherpropertyname;
    options.messages["decimalgreaterthan"] = options.message;
});